...
'''
    ...
    layers = Conv2D(filters=8, kernel_size=(3, 3), activation='relu') (input)
    layers = MaxPooling2D(pool_size=(2, 2)) (layers)
    layers = Conv2D(filters=16, kernel_size=(3, 3), activation='relu') (layers)
    layers = MaxPooling2D(pool_size=(2, 2)) (layers)
    layers = Flatten() (layers)
    layers = Dense(units=256, activation='relu') (layers)
    layers = Dropout(0.15) (layers)
    layers = Dense(units=256, activation='relu') (layers)
    layers = Dropout(0.15) (layers)
