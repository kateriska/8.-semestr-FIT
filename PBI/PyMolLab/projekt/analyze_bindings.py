...
# DONT FORGET TO SWICH TO SPECIFIED STATE FOR LOOKING FOR SELECTIONS BECAUSE THEY ARE SPECIAL FOR EACH STATE
...
#cmd.distance("state_1_dist_1", "/prot1_prepared//B/ASP`25/OD1", "/ligand//N/UNK`1/H")
